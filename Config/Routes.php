...
$routes->group('api', $rest_api_namespace, function ($routes) {
	...
	//WordPress Plugin
	$routes->post('clients/auth', 'ClientsController::authenticate'); //authenticate
	$routes->post('clients/add', 'ClientsController::createClient'); //Create A client
	$routes->get('users/search/(:segment)', 'ClientsController::findUserByEmail/$1'); //get search
